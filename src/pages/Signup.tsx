    ...
    <div className="min-h-screen flex items-center justify-center px-6 mt-5">
      <div className="w-full max-w-md p-10 bg-white border-2 border-black rounded-xl shadow-[6px_6px_0px_rgba(0,0,0,0.25)] flex flex-col gap-8">
        ...
        <button
          ...
          className="w-full px-5 py-3 bg-black text-white rounded-lg font-passero shadow-[4px_4px_0px_rgba(0,0,0,0.25)] transform transition-all hover:scale-100 hover:shadow-[8px_8px_0px_rgba(0,0,0,0.25)]"
        >
          Sign Up
        </button>
        ...
        <div className="flex justify-center text-sm font-patrick mt-2">
          ...
          <a href="/login" className="ml-1 hover:underline text-black/90">Sign In</a>
        </div>
      </div>
    </div>
  );
